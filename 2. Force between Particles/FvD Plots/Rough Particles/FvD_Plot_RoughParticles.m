...
scatter(PlotData.gaps{1}, PlotData.Fdimless{1}, 50, 'red', '^', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{3}, PlotData.Fdimless{3}, 50, 'blue', '^', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{5}, PlotData.Fdimless{5}, 50, 'm', '^', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{7}, PlotData.Fdimless{7}, 50, 'c', '^', 'filled', 'MarkerEdgeColor', 'k');

scatter(PlotData.gaps{2}, PlotData.Fdimless{2}, 50, 'red', 's', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{4}, PlotData.Fdimless{4}, 50, 'blue', 's', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{6}, PlotData.Fdimless{6}, 50, 'm', 's', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{8}, PlotData.Fdimless{8}, 50, 'c', 's', 'filled', 'MarkerEdgeColor', 'k');


xlabel('{\boldmath $d/R$}','fontsize',20,'fontname','Times New Roman','interpreter','latex');
...
legStr = {'$1392$ patches, $A = 0.05$, tip-tip, $\sigma_1 = 1, \sigma_2 = -1$', ...
    '$1562$ patches, $A = 0.1$, tip-tip, $\sigma_1 = 1, \sigma_2 = -1$', ...
    '$1704$ patches, $A = 0.15$, tip-tip, $\sigma_1 = 1, \sigma_2 = -1$', ...
    '$2732$ patches, $A = 0.20$, tip-tip, $\sigma_1 = 1, \sigma_2 = -1$', ...
...
legend(legStr,'location','southeast','fontsize',12,'interpreter','latex');
