...
% red: pos1pos10 blue: pos1pos1 green: pos1neg1
...
scatter(PlotData.gaps{3}, PlotData.Fdimless{3}, 70, 'green', '>', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{4}, PlotData.Fdimless{4}, 70, 'blue', '>', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{5}, PlotData.Fdimless{5}, 70, 'green', '*', 'filled', 'MarkerEdgeColor', 'k');


xlabel('\it{d/R}','fontsize',20,'fontname','Times New Roman');
...
legStr = {'10000 patches - Pos1Pos10','1000 patches - Pos1Neg1','1000 patches - Pos1Pos1','5000 patches - Pos1Neg1'};
