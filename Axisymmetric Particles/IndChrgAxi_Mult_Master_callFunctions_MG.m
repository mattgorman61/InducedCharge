...
dxs = [5,5,5]; dys = [0, 2.20*R0, 5*R0]; dzs = [0,0.25*R0,0];
...
if(lshowForceResults)
    figure();
    F_Plot_ForceVectors(numSpheres,NpatchesSph,R0,x,y,z,dA,nVect,x_pcs,y_pcs,z_pcs,pcharge,lpCharge,lEField,sigma_b,sigma_f,k_air,k_obj,epsilon_0);
end
