function [ContactPoint] = F_CollPoint_XRBlackBox(S_0,S_1)
...
%     ContactPoint(1),ContactPoint(2),ContactPoint(3));
    ...
    % Check if point on ellipsoidal surface
%     A1_sub = reshape(A1,[3,3]);
%     test1 = ContactPoint*A1_sub*ContactPoint'+bVec1*ContactPoint'+q(4,4);
%     fprintf('P_(%d)(x)=(x^T)A_%d(x)+(b_%d^T)x+c_1=%f\n',mm,mm,mm,test1);
