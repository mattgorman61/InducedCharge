clear; close all; clc;
% INDUCED CHARGE ON MULTIPLE ELLIPSES
fprintf('INDUCED CHARGE ON MULTIPLE ELLIPSES\n\n');
...
% Plot Ellipse with or without Normal Vectors
if(lshowEllipse)
    figure();
...
%% CALL FUNCTIONS
% Multiple Ellipses:
[sigma_b,b] = F_getSigmaB_Mult_Matrix(NEll,NpatchesEll,dAmat,x,y,z,nVect,x_pcs,y_pcs,z_pcs,pcharge,sigma_f,k_air,k_obj,Ext_EField_x,Ext_EField_y,Ext_EField_z);
