...
R = [R0, R0, R0];
%R = R0;
NpatchesSph = 576; % Number of patches per sphere. Have to change every time distmesh settings are changed.
numSpheres = 2; 
...
%     [x_n,y_n,z_n,dA_n,nVect_n,sphereID_n] = F_createAxiSymmPar_distmesh(R(n),NpatchesSph,dxs(n),dys(n),dzs(n),n);
