...
beta = 6;
elemSize = 0.04;
symmOpt = 't'; % 't' = theta, 'p' = phi, 'both' = both theta and phi symmetry

dxs = [0]; dys = [0]; dzs = [0];  % x,y,z coordinates for sphere center
[x_n,y_n,z_n,dA_n,V_n,nVect_n] = F_createAxiSymmPar_distmesh(R,dxs,dys,dzs,A,alpha,elemSize,symmOpt,B,beta);
...
filenameStr = ['ParData_temp_',num2str(length(x))];
