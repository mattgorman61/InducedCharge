...
scatter(PlotData.gaps{2}, PlotData.Fdimless{2}, 50, 'blue', '^', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{3}, PlotData.Fdimless{3}, 70, 'red', 'p', 'filled', 'MarkerEdgeColor', 'k');
scatter(PlotData.gaps{4}, PlotData.Fdimless{4}, 70, 'blue', 'p', 'filled', 'MarkerEdgeColor', 'k');

xlabel('\it{Particle Surface Dist Approx. (units of sphere radius)}','fontsize',20,'fontname','Times New Roman');
ylabel('{\boldmath$\frac{F}{|F_0|}$}','fontsize',24,'fontname','Times New Roman','interpreter','latex');
...
legStr = {'536 patches - Mount-Val','536 patches - Tip-Tip','2088 patches - Mount-Val','2088 patches - Tip-Tip'};
legend(legStr,'location','southeast','fontsize',12);
